...
export const animatePageIn = () => {
  ...
  document.body.insertAdjacentHTML('afterbegin', `
    <div id="pre-animation-message" class="uppercase text-2xl md:text-6xl font-viola" 
         style="position: fixed; width: 100%; height: 100%; display: flex; 
                flex-direction: column; align-items: center; justify-content: center; 
                z-index: 99990; color: white; opacity: 0;">
        <div>rita hory</div>
      <div class = "uppercase text-xl md:text-4xl font-viola p-2">@Pudding_2159</div>
    </div>
  `);
